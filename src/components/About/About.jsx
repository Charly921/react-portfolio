    ...
    return <section className={styles.container} id='servicios'>
        ...
        <div className={styles.content}>
            <img
                ...
                alt="Ilustración de servicios de desarrollo web"
                className={styles.aboutImg}
                loading="lazy"
            />
            <ul className={styles.aboutItems}>
                <li className={styles.aboutItem}>
                    <img src={getImageUrl("about/image1.png")} alt="" loading="lazy" />
                ...
                <li className={styles.aboutItem}>
                    <img src={getImageUrl("about/image3.png")} alt="" loading="lazy" />
                    <div className={styles.aboutItemText}>
                ...
                <li className={styles.aboutItem}>
                    <img src={getImageUrl("about/image2.png")} alt="" loading="lazy" />
                    <div className={styles.aboutItemText}>
